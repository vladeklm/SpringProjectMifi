...
public class BookingService {
    ...
    @Transactional
    public Booking createBooking(BookingRequestDto dto, String token, String username) {
    ...
    @Transactional
    public Booking cancelBooking(Long bookingId, String token, String username) {
